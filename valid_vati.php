...
<head>
    ...
    <link rel="stylesheet" href="styles/style_valid_vati.css">
    <meta charset="UTF-8">
...
<body>
    <div class="car">
        <div class="section_register">
            <h1>¡Resultados Ingresados!</h1>
            <p class="description"></p>
            <section class="section">
                <div class="galeria">
                    <img src="img/check-green.gif" alt="">
                </div>
            </section>
            <div class="form">
                <button onclick="location.href='calendar.php'" name="button_submit" class="button_submit">Continuar</button>
            </div>
            </form>
        </div>
    </div>
