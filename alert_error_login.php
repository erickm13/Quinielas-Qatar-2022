...
<body>
    <div class="car">
        <div class="section_register">
            <h1>¡Error!</h1>
            <p class="description">Error al iniciar sesion, usuario o contraseña incorrecta. Por favor revisa los campos y vuelve a intentarlo</p>
            ...
            <div class="form">
                <button onclick="location.href='login.html'" name="button_submit" class="button_submit">Vuelve a intentarlo</button>
            </div>
            </form>
        </div>
    </div>
